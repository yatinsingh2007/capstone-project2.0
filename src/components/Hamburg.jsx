...
const Hamburg = () => {
  ...
  return (
    <nav className="bg-white text-black fixed top-0 left-0 w-full z-20 backdrop-blur-sm" style={{ fontFamily: "'Sora', sans-serif" }}>
      ...
      >
        <ul className="flex flex-col space-y-4 px-6 py-4 font-light bg-white/90">
