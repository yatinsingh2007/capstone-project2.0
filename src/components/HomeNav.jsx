...
const HomeNav = () => {
  return (
    <nav className="fixed top-0 w-full bg-white/70 text-black z-20 backdrop-blur-sm" style={{ fontFamily: "'Sora', sans-serif" }}>
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
            ...
            <ul className="flex md:flex space-x-6 font-light">
                <li onClick={() => window.scroll()}><a href="#home" className="hover:text-blue-800">Home</a></li>
